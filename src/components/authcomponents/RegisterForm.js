...
export default function RegisterForm() {
    ...
    return (_jsxs(_Fragment, { children: [error && (_jsxs(Alert, { variant: "destructive", className: "max-w-md", children: [_jsx(AlertCircleIcon, {}), _jsx(AlertTitle, { children: "Login failed" }), _jsx(AlertDescription, { children: error })] })), _jsxs("form", { id: "login_form", onSubmit: (e) => {
                    ...
                    form.handleSubmit();
                            ...
                            return (_jsxs(Field, { "data-invalid": isInvalid, children: [_jsx(FieldLabel, { htmlFor: field.name, children: "Full Name" }), _jsxs(InputGroup, { className: "bg-white py-4", children: [_jsx(InputGroupInput, { id: field.name, name: field.name, value: field.state.value, onBlur: field.handleBlur, onChange: (e) => field.handleChange(e.target.value), "aria-invalid": isInvalid, placeholder: "e.g 070000", 
                                                //className="bg-white"
                                                autoComplete: "off" }), _jsx(InputGroupAddon, { align: "inline-start", children: _jsx(IconUser, { className: "text-muted-foreground" }) })] }), isInvalid && (_jsx(FieldError, { errors: field.state.meta.errors }))] }));
                        } }), _jsx(form.Field, { name: "email", children: (field) => {
                            const isInvalid = field.state.meta.isTouched && !field.state.meta.isValid;
                            return (_jsxs(Field, { "data-invalid": isInvalid, className: "py-4", children: [_jsx(FieldLabel, { htmlFor: field.name, children: "Email Address" }), _jsxs(InputGroup, { className: "bg-white py-4", children: [_jsx(InputGroupInput, { id: field.name, name: field.name, value: field.state.value, onBlur: field.handleBlur, onChange: (e) => field.handleChange(e.target.value), "aria-invalid": isInvalid, 
                                                //className="bg-white"
                        ...
                        } }), _jsxs(FieldGroup, { children: [_jsx(form.Field, { name: "number", children: (field) => {
                                    const isInvalid = field.state.meta.isTouched && !field.state.meta.isValid;
                                    return (_jsxs(Field, { "data-invalid": isInvalid, children: [_jsx(FieldLabel, { htmlFor: field.name, children: "Phone Number" }), _jsxs(InputGroup, { className: "bg-white py-4", children: [_jsx(InputGroupInput, { id: field.name, name: field.name, value: field.state.value, onBlur: field.handleBlur, onChange: (e) => field.handleChange(e.target.value), "aria-invalid": isInvalid, placeholder: "e.g 070000", 
                                                        //className="bg-white"
                                                        autoComplete: "off" }), _jsx(InputGroupAddon, { align: "inline-start", children: _jsx(IconPhone, { className: "text-muted-foreground" }) })] }), isInvalid && (_jsx(FieldError, { errors: field.state.meta.errors }))] }));
                                ...
                                } })] }), _jsx(Separator, { className: "my-4" }), _jsx(Submitbtn, { text: "Create Account", fullwidth: true, type: "submit", loading: loading })] })] }));
}
